...
class DtsApi():
    ...
    async def async_upload_file(self, remote: StrictStr, path: StrictStr, file_path: StrictStr):
        return openapi_client.DataTransferApi(self.client).data_remote_path_post(remote, path, file_path, async_req=True)
    ...
    async def async_copy(self, operations: conlist(RestSrcDst)):
        return openapi_client.StorageApi(self.client).storagecopy_post(RestSrcDstOperations(operations=operations), async_req=True)
    ...
    async def async_exists(self, operations: conlist(RestStoragePath)):
        return openapi_client.StorageApi(self.client).storageexists_post(RestPathOperations(operations=operations), async_req=True)
    ...
    async def async_list(self, operations: conlist(RestSrcDst)):
        return openapi_client.StorageApi(self.client).storagelist_post(RestPathOperations(operations=operations), async_req=True)
    ...
    async def async_mkdir(self, operations: conlist(RestStoragePath)):
        return openapi_client.StorageApi(self.client).storagemkdir_post(RestPathOperations(operations=operations), async_req=True)
    ...
    async def async_move(self, operations: conlist(RestSrcDst)):
        return openapi_client.StorageApi(self.client).storagemove_post(RestSrcDstOperations(operations=operations), async_req=True)
    ...
    async def async_remove(self, operations: conlist(RestStoragePath)):
        return openapi_client.StorageApi(self.client).storageremove_post(RestPathOperations(operations=operations), async_req=True)
    ...
    async def async_rmdir(self, operations: conlist(RestStoragePath)):
        return openapi_client.StorageApi(self.client).storage_get(RestPathOperations(operations=operations), async_req=True)