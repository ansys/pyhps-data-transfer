...
class RestOpsResponse(BaseModel):
    """
    RestOpsResponse
    """
    operations: Optional[conlist(OpsOperation)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RestOpsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RestOpsResponse:
        """Create an instance of RestOpsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RestOpsResponse.parse_obj(obj)

        _obj = RestOpsResponse.parse_obj({
            "operations": [OpsOperation.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
