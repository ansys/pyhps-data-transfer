...
class RestPathOperations(BaseModel):
    """
    RestPathOperations
    """
    operations: conlist(RestStoragePath) = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RestPathOperations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RestPathOperations:
        """Create an instance of RestPathOperations from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RestPathOperations.parse_obj(obj)

        _obj = RestPathOperations.parse_obj({
            "operations": [RestStoragePath.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
